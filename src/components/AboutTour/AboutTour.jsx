    ...
    return (
        <section className='about-tour'>
            <div className='about-tour__video-container'>
                <picture className='about-tour__video about-tour__video_front'><button type='button' aria-label='Воспроизведение' className='about-tour__play-button' /></picture>
                <picture href='#' className='about-tour__video about-tour__video_back'><button type='button' aria-label='Воспроизведение' className='about-tour__play-button' /></picture>
            </div>
            <div className='about-tour__info'>
                ...
                <button type='button' aria-label='Программа тура' className='main__button'>Программа тура</button>
            </div>
        </section>
    );
}