        ...
        <footer className='footer'>
            <div className='footer__container'>
                ...
                <nav className='footer__nav'>
                    ...
                    <ul className='footer__nav-links'>
                        ...
                        <li className='footer__nav-item'>
                            <a href='#' className='footer__link footer__nav-link'>Походы в джунглях Амазонии
                                <p className='footer__nav-link_highlighted'>new</p>
                            </a>
                        </li>
                        <li className='footer__nav-item'>
            ...
            <div className='footer__copyright'>
                <div className='footer__copyright-container'>
                    <p className='footer__copyright-holder'>ИП Константинопольский К.К., {new Date().getFullYear()}</p>
                    <a href='#' className='footer__copyright-link'>Политика обработки персональных данных</a>
                </div>
            </div>
        </footer>
    )
