        ...
        <section className='offer'>
            <div className='offer__container'>
                <div className='offer__info'>
                    ...
                    <button type='button' className='main__button'>Стоимость программ</button>
                </div>
                <div className='offer__images'>
                    <img src={img1} alt="" className='offer__image offer__image_left' />
                    <img src={img2} alt="" className='offer__image offer__image_right' />
                    <img src={img3} alt="" className='offer__image offer__image_right' />
                    <img src={img4} alt="" className='offer__image offer__image_left' />
                </div>
            </div>
        </section>
    );
